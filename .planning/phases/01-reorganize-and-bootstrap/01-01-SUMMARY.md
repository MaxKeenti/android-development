...
- `ui/news/app/src/main/java/com/maxkeenti/news/MainActivity.kt` — FOUND
- `ui/news/app/build.gradle.kts` — FOUND
- `ui/news/settings.gradle.kts` — FOUND
- `ui/jukebox/app/src/main/java/com/maxkeenti/jukebox/MainActivity.kt` — FOUND
- `ui/jukebox/app/build.gradle.kts` — FOUND
- `ui/jukebox/settings.gradle.kts` — FOUND
- Commit `246d975` — FOUND
- Commit `ba56994` — FOUND
