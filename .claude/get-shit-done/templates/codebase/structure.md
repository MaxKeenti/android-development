...
- Usage: Reference from command with `@/Users/maximilianogonzalezcalzada/Source/Personal/android-development/.claude/get-shit-done/workflows/{name}.md`
...
**get-shit-done/**
- Purpose: Resources installed to /Users/maximilianogonzalezcalzada/Source/Personal/android-development/.claude/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)

**commands/**
- Purpose: Slash commands installed to /Users/maximilianogonzalezcalzada/Source/Personal/android-development/.claude/commands/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)
