...
- **Global scope**: `/Users/maximilianogonzalezcalzada/Source/Personal/android-development/.claude/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/Users/maximilianogonzalezcalzada/Source/Personal/android-development/.claude/notes/`)
...
2. Glob `/Users/maximilianogonzalezcalzada/Source/Personal/android-development/.claude/notes/*.md` (if directory exists) — global notes
...
Global (/Users/maximilianogonzalezcalzada/Source/Personal/android-development/.claude/notes/):
...
2. **No `.planning/`**: Falls back to global `/Users/maximilianogonzalezcalzada/Source/Personal/android-development/.claude/notes/` — works in any directory
