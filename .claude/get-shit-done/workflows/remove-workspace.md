...
```bash
INIT=$(node "/Users/maximilianogonzalezcalzada/Source/Personal/android-development/.claude/get-shit-done/bin/gsd-tools.cjs" init remove-workspace "$WORKSPACE_NAME")
