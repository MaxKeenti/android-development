...
- Implement a DataStore-based app that stores user preferences and demonstrates proto-buf serialization
- Assigned by: Teacher

## 2. Concept Covered

- Proto-based data persistence with Protocol Buffers
