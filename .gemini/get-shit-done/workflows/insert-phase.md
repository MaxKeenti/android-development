...
```bash
INIT=$(node "/Users/maximilianogonzalezcalzada/Source/Personal/android-development/.gemini/get-shit-done/bin/gsd-tools.cjs" init phase-op "${after_phase}")
...
```bash
RESULT=$(node "/Users/maximilianogonzalezcalzada/Source/Personal/android-development/.gemini/get-shit-done/bin/gsd-tools.cjs" phase insert "${after_phase}" "${description}")
```
