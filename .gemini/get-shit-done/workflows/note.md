...
- **Global scope**: `/Users/maximilianogonzalezcalzada/Source/Personal/android-development/.gemini/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/Users/maximilianogonzalezcalzada/Source/Personal/android-development/.gemini/notes/`)
...
2. Glob `/Users/maximilianogonzalezcalzada/Source/Personal/android-development/.gemini/notes/*.md` (if directory exists) — global notes
...
Global (/Users/maximilianogonzalezcalzada/Source/Personal/android-development/.gemini/notes/):
...
2. **No `.planning/`**: Falls back to global `/Users/maximilianogonzalezcalzada/Source/Personal/android-development/.gemini/notes/` — works in any directory
